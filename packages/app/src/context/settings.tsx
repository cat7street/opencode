  ...
  init: () => {
    ...
    return {
      ...
      general: {
        ...
        // Session components still read this while the surrounding layout migration is retired.
        newLayoutDesigns: createMemo(() => true),
        initializeAgentVisibility(existing: boolean) {
          if (store.general?.agentVisibilityInitialized === true) return
          setStore("general", "showCustomAgents", initialAgentVisibility(undefined, existing) ?? false)
